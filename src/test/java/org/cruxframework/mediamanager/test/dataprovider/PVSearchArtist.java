...
/**
 * Class description: This class contains methods that return the inputs for testing the class CTSearchArtist for each method of test exist
 * a method provider of input, the name of a methods provider reference a method of test, e.g the method PV001_LoginFail in class PVLogin
...
public class PVSearchArtist
{
	...
	{
		return new Object[][] { { "Artista01P006", new Artist("Artista01P006", "Mexico", "Metal") },
	...
	{
		return new Object[][] { { "Not Exist" }, };
	}

	@DataProvider(name = "PV003_DeleteArtist")
	public static Object[][] PV003_DeleteArtist()
	{
		return new Object[][] { { "ArtistForDelete" }, };
	}

	@DataProvider(name = "PV004_EditAndSearchArtist")
	public static Object[][] PV004_EditAndSearchArtist()
	{
		return new Object[][] { { new Artist("ArtistForEdit", "United States", "Metal"),
		    new Artist("Mamonas Assassinas", "Jamaica", "Blues") }, };
	}

	@DataProvider(name = "PV005_ChangeValuesSearch")
	public static Object[][] PV005_ChangeValuesSearch()
	{
		return new Object[][] { { "Artista01P006", "Artista02P006", new Artist("Artista01P006", "Mexico", "Metal"),
		    new Artist("Artista02P006", "England", "Jazz") }, };
	}
}
